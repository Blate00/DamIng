  ...
  return (
    <div className="flex flex-col bg-white h-full p-5">
      <div className='bg-white h-full rounded-lg'>
        ...
        {/* Aquí agregamos el componente TrabajadorDetalle */}
              ...
              <tbody>
                {pagos.map((pago, index) => (
                  <tr key={index} className="border-b border-gray-200">
                    ...
                    <td className="px-4 py-2 border text-center text-gray-800"> {pago.pagoDia}</td>
                    <td className="px-4 py-2 border text-center text-gray-800"> {pago.colacion}</td>
                    <td className="px-4 py-2 border text-center text-gray-800"> {pago.gestion}</td>
                    <td className="px-4 py-2 border text-center text-gray-800"> {pago.extra}</td>
                    <td className="px-4 py-2 border text-center text-gray-800"> {pago.total.toLocaleString('es-CL', { style: 'currency', currency: 'CLP' })}</td>
                  </tr>
                ))}
