...
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-5">
  <div className="p-4 h-32 rounded-xl shadow-md flex items-center bg-gradient-to-r from-red-800 to-red-900">
    ...
    <div className="ml-4 text-left">
      <h2 className="text-white font-semibold">Balance Total</h2>
      <p className="text-white text-xl font-bold">GG 0</p>
      <p className="text-white text-xl font-bold">Gestión 0</p>
    </div>
  </div>
